    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(upload_to=projects.models.board_thumbnail_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pictures', to='projects.Board')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64)),
                ('slug', models.SlugField(help_text='URL name: <em>thunderatz.org/projects/robots/&lt;slug&gt;</em>', unique=True)),
                ('logo', models.ImageField(upload_to='project_logos')),
                ('typography', models.ImageField(upload_to='project_typography')),
                ('cover_image', models.ImageField(upload_to=projects.models.project_cover_path)),
                ('card_image', models.ImageField(upload_to=projects.models.project_card_path)),
                ...
                ('bold', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.Member')),
